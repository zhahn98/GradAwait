...
namespace GradAwait.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "MessageBoard",
                columns: new[] { "Id", "Date", "Image", "Message", "UserId" },
                values: new object[] { 1, "5-8-24", "https://imgur.com/", "Amazing post!", 1 });

            migrationBuilder.InsertData(
                table: "NewsLetter",
                columns: new[] { "Id", "Body", "Date", "Image", "Title", "UserId" },
                values: new object[] { 1, "The NSS grads are so great", "5-8-24", "https://imgur.com/", "New Newsletter Post!", 1 });

            migrationBuilder.InsertData(
                table: "Project",
                columns: new[] { "Id", "Description", "ProjectName", "Url", "UserId" },
                values: new object[] { 1, "This is the first project", "Project 1", "https://github.com/", 1 });

            migrationBuilder.InsertData(
                table: "Reaction",
                columns: new[] { "Id", "MsgId", "ReactionTypeId", "UserId" },
